...
async function main() {
  ...
  console.log("Fetching Turkey players from Supabase...");
  const { data, error } = await supabaseAdmin
    .from("team_rosters")
    .select("player_name, player_position, club, player_number")
    .eq("team_id", "tur")
  ...
  console.log(`Found ${data?.length || 0} players for Turkey:`);
