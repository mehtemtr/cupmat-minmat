...
async function main() {
  ...
  console.log("Searching for profiles in Supabase...");
  ...
  const matches = profiles.filter(p => 
    p.email.toLowerCase().includes("fatma") || 
    p.nickname?.toLowerCase().includes("eagle") ||
    p.nickname?.toLowerCase().includes("fatma")
  );
