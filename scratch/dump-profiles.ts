...
async function main() {
  ...
  console.log("Fetching all profiles rows...");
  ...
  const outPath = path.join(__dirname, "profiles-all.json");
  fs.writeFileSync(outPath, JSON.stringify(data, null, 2), "utf8");
  console.log(`Successfully dumped ${data.length} profiles to ${outPath}`);
}
