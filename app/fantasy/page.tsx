...
const shareTranslations: Record<string, { shareBtn: string; successMsg: string; alreadyClaimed: string; errorMsg: string; shareText: string }> = {
  tr: {
    ...
    shareText: "StatMatik CupMat Taktikte rüya kadromu kurdum! Sen de katıl, ödülleri kazan! 🏆⚽",
  },
  en: {
    ...
    shareText: "I built my dream roster in StatMatik CupMat Tactics! Join now and win prizes! 🏆⚽",
  },
  de: {
    ...
    shareText: "Ich habe mein Traum-Roster bei StatMatik CupMat Taktik zusammengestellt! Mach mit und gewinne Preise! 🏆⚽",
  },
  fr: {
    ...
    shareText: "J'ai créé mon équipe de rêve dans StatMatik CupMat Tactique ! Rejoins-nous et gagne des prix ! 🏆⚽",
  },
  es: {
    ...
    shareText: "¡Armé mi plantilla de ensueño en StatMatik CupMat Táctica! ¡Únete ahora y gana premios! 🏆⚽",
  },
  pt: {
    ...
    shareText: "Montei minha escalação dos sonhos no StatMatik CupMat Táticas! Participe e ganhe prêmios! 🏆⚽",
  },
  it: {
    ...
    shareText: "Ho creato la mia rosa dei sogni su StatMatik CupMat Tattiche! Partecipa anche tu e vinci premi! 🏆⚽",
  },
  ko: {
    ...
    shareText: "StatMatik CupMat 전술에서 드림 스쿼드를 구축했습니다! 지금 가입하고 다양한 상품을 받아보세요! 🏆⚽",
  },
  ar: {
    ...
    shareText: "لقد أنشأت تشكيلتي المثالية في تكتيكات CupMat! انضم الآن واربح الجوائز! 🏆⚽",
  },
};
