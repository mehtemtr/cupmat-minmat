...
export function MinlanHeader({
  ...
  return (
    <div className="w-full pb-3 mb-2 border-b border-slate-800/80 flex flex-col items-center select-none">
      ...
      {/* Compact Live Community Match Progress Bar (Hiddable via showCommunityGoal prop) */}
      {showCommunityGoal && (
        <div className="w-full space-y-1.5 pt-2 border-t border-slate-800/60 mt-2">
